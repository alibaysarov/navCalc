...
export const getMeAirports=createAsyncThunk('ui/getMeAirports',async(_,{getState})=>{
const {viewPortConstr}=getState().map;
const [lng1,lat1,lng2,lat2]=viewPortConstr;
const url='http://localhost:5000/api/airports'+`?lng1=${lng1}&lat1=${lat1}&lng2=${lng2}&lat2=${lat2}`
...
export const {drawHandler,removeZones,removeAirports,viewPortHandler}=mapSlice.actions;
